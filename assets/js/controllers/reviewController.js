...
export class ReviewController {
     ...
     */
    async showCreateReviewForTicketForm(ticketId) {
        try {
     ...
     */
    addReviewForTicketFormEventListeners() {
        const form = document.getElementById('create-review-for-ticket-form');
        const cancelBtn = document.getElementById('review-cancel-btn');
        const navLogout = document.getElementById('nav-logout');
        const navFeed = document.getElementById('nav-feed');
        const navPosts = document.getElementById('nav-posts');
    ...
    async handleCreateReview() {
        ...
        const imageInput = document.getElementById('ticket-image-input');
        const reviewHeadlineInput = document.getElementById('review-headline');
     ...
     */
    async handleCreateReviewForTicket() {
     ...
     */
    async showEditReviewForm(reviewId) {
        try {
     ...
     */
    addEditReviewFormEventListeners() {
