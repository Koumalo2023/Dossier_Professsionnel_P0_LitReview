...
export class AuthService {
    private static readonly TOKEN_KEY = 'litreview_auth_token';
    private static readonly USER_ID_KEY = 'litreview_user_id';
    private static readonly USERNAME_KEY = 'litreview_username';
     ...
     */
    static setAuthInfo(token: string, userId: number, username: string): void {
     ...
     */
    static async login(username: string, password: string): Promise<{ token: string, userId: number, username: string }> {
        try {
     ...
     */
    static async register(username: string, password: string): Promise<{ token: string, userId: number, username: string }> {
        try {
     ...
     */
    private static generateSimulatedJWT(userId: number, username: string): string {
