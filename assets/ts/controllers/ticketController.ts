...
export class TicketController {
     ...
     */
    public showCreateTicketForm(): void {
     ...
     */
    private addTicketFormEventListeners(): void {
     ...
     */
    public async showEditTicketForm(ticketId: number): Promise<void> {
        try {
     ...
     */
    private addEditTicketFormEventListeners(ticketId: number): void {
     ...
     */
    private async handleUpdateTicket(ticketId: number): Promise<void> {
        const titleInput = document.getElementById('ticket-title') as HTMLInputElement;
        const descriptionInput = document.getElementById('ticket-description') as HTMLTextAreaElement;
        const imageInput = document.getElementById('ticket-image-input') as HTMLInputElement;
        const errorElement = document.getElementById('ticket-error');
